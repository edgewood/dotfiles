...
" abbreviations (adding undo point before expanding)
iabbrev rjc <c-g>uRaleigh Jaycee
...
" automatically reformat paragraphs as I type
setlocal formatoptions+=a
" prevent "-" lists from being indented, which adds spaces into flowed text
" Unfortunately, it also messes up quoted text reformatting.
"setlocal formatoptions-=q
" don't autoindent or smartindent, as that adds spaces into middle of flowed
" text paragraphs
set noautoindent
set nosmartindent
" map end-of-file motion to search for the line before beginning of the
" signature, so that, for example, dG or cG won't remove the signature when
" deleting or changing.
omap G /\n-- 

" load region-based autoformat script
runtime mail/format.vim
" prompt for files to attach if message contains attachment keywords
runtime mail/muttAttach.vim
" ====================================================================
"                               Globals
" ====================================================================
...
if !exists("no_plugin_maps") && !exists("no_mail_maps")
    ...
    " * <C-q> to re-format the current paragraph correctly
...
"        nmap <buffer> <unique> <C-q> <Plug>MailFormatParagraph
"    endif
"
...
"        imap <buffer> <unique> <C-q> <Plug>MailFormatParagraph
"    endif
"
...
"    inoremap <buffer>          <SID>FormatParagraph <ESC>gqapi
    ...
    "
    " Map Alt-W to change the subject, adding "[was: old subject]"
    " Doesn't currently work
    "au BufNewFile,BufRead   /tmp/mutt-*   map <M-w> gg/Re:ce[wasA]0Wi
endif
